        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnsweredId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Messages_Messages_AnsweredId",
                        column: x => x.AnsweredId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSpecialtyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AnsweredId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Messages_AnsweredId",
                        column: x => x.AnsweredId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Specialties_MainSpecialtyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AnsweredId",
                table: "Users",
                column: "AnsweredId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_MainSpecialtyId",
                table: "Users",
