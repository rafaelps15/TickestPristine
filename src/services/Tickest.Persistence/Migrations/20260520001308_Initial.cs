    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name", "Description", "IsActive", "IsDeleted", "CreatedAt", "DeactivatedAt", "UpdateAt" },
                values: new object[,]
                {
                    { new Guid("b0f7b3e9-2e87-47f6-9f2f-8e21d0c9f5a1"), "AdminMaster", "Dono do software.", true, false, new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc), null, null },
                    { new Guid("77f387b6-3b25-48d1-9d03-b7a71162ecb7"), "TicketManager", "Gestor de tickets.", true, false, new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc), null, null },
                    { new Guid("a75bb5e8-5a1d-4960-8f49-8db38e7a3df1"), "Collaborator", "Colaborador solicitante.", true, false, new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc), null, null }
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Areas_Sectors_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sectors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Areas_Specialties_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Areas_Users_ResponsibleUserId",
                        column: x => x.ResponsibleUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AreaUserSpecialties", x => new { x.AreaId, x.UserId, x.SpecialtyId });
                    table.ForeignKey(
                        name: "FK_AreaUserSpecialties_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AreaUserSpecialties_Specialties_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AreaUserSpecialties_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Areas_ResponsibleUserId",
                table: "Areas",
                column: "ResponsibleUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Areas_SectorId",
                table: "Areas",
                column: "SectorId");

            migrationBuilder.CreateIndex(
                name: "IX_Areas_SpecialtyId",
                table: "Areas",
                column: "SpecialtyId");

            migrationBuilder.CreateIndex(
                name: "IX_AreaUserSpecialties_SpecialtyId",
                table: "AreaUserSpecialties",
                column: "SpecialtyId");

            migrationBuilder.CreateIndex(
                name: "IX_AreaUserSpecialties_UserId",
                table: "AreaUserSpecialties",
                column: "UserId");
