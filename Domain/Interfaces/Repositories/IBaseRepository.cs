...
public interface IBaseRepository<TEntity> where TEntity : EntityBase
{
    ...
    /// </summary>
    /// <param name="cancellationToken">Token de cancelamento opcional para interromper a operação.</param>
    /// <returns>A tarefa assíncrona representando a operação de salvar alterações.</returns>
